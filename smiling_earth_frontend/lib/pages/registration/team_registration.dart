        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 20),
              Text(
                  'One of the things this application wants to understand is how adding online communities could enhance the system.\nTherby we introduce "Teams". You can compare your carbon emission with the other team members and look at the team\'s combined carbon emissions. \nYou can also discuss with the other team members, join team challenges and compare the team\'s CO2 emissions to other rivaling teams'),
              SizedBox(height: 20),
              Text(
                'You are a member of:',
