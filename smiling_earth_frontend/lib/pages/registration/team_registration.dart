        ...
        body: Container(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 20),
              Text(
                  'One of the things this application wants to understand is how adding online communities could enhance the system. Therby we indroduce "Teams". In a team you can compare your carbon emission with the other members and look at the team\'s combined carbon emissions. \nYou can also discuss with the other team members, join challenges and compare the teams emissions to other rivaling teams'),
              SizedBox(height: 20),
              Text(
                'You are a member of:',
