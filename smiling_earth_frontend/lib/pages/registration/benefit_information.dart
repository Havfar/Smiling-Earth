              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "There are many benefits of choosing the greener option.\n In addition to help saving the planet and reach the 2-degree goal of the United Nations, you can save money, and gain healt benefits if you choose to walk or cycle instead of driving.",
                      textAlign: TextAlign.center,
                      style:
